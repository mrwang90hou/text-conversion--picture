...
namespace _0713将文字保存成图片
{
    ...
    public class DbHelperSQL
    {
        ...
        #region 公用方法
        //public static string ConnectionString { get; set; }////获取数据库连接字符串
        public static int GetMaxID(string FieldName, string TableName)//获取最大ID
        {
        ...
        public static bool Exists(string strSql, params SqlParameter[] cmdParms)    //存在函数
        {
        ...
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingle(string SQLString, params SqlParameter[] cmdParms)//得到唯一
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
